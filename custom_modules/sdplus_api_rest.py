...
def eg_get_requests(filter_by='All_Requests', limit='1000', frm='0'):
    """
    ...
    :param filter_by: Queue name (not value) to search
    ...
    calls_from_sdplus = api.output_params_to_list(calls_from_sdplus)
    for call in calls_from_sdplus:
        call['createdtime'] = api.epoch_to_datetime(call['createdtime'])
...
def eg_get_all_technicians():
    ...
    """
    api = API(os.environ['SDPLUS_ADMIN'], 'http://sdplus/sdpapi/technician/')
